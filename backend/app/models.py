...
class JobPost(Base):
    ...
    canonical_remote: Mapped[int] = mapped_column(Integer, default=1)
    canonical_salary_min: Mapped[int] = mapped_column(Integer, default=0)
    canonical_salary_max: Mapped[int] = mapped_column(Integer, default=0)
    canonical_currency: Mapped[str] = mapped_column(String(16), default="USD")
    canonical_skills: Mapped[str] = mapped_column(Text, default="[]")
